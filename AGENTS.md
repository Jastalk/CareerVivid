...
- **Mandatory Universal UX/UI Design System & Storytelling Pattern**: EVERY System Design video generated across ANY domain (AI, Voice, Geospatial, Databases, Queues, Media, Security) MUST strictly implement the paper-collage UX/UI design system (newsprint grid paper backdrop, color-coded deckled-edge cards, bold module block letters like STT/LLM/TTS/GPS/H3/KAFKA/REDIS/WEBRTC, explicit cutout icons like stopwatches/headphones/microphones/taxis/bolts/locks/databases, visual warning indicators, and progressive 3-block story hooks).
