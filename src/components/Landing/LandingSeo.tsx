...
/*
 * The public landing page's search identity, in one place.
 *
 * Both the live landing page and the classic one render this. They are the same
 * site to a crawler — same canonical, same organisation, same FAQ — and letting
 * each keep its own copy is how those quietly drift apart.
 */
...
export const LANDING_SEO_DESCRIPTION = SEO_DESCRIPTION;

const LandingSeo: React.FC = () => (
