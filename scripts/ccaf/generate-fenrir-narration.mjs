/**
 * generate-fenrir-narration.mjs
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips for Domain 1.
 */
...
const OUT_DIR = 'public/assets/ccaf-narration/domain-1-overview/en/chirp-fenrir';
...
export async function generateFenrir() {
    console.log('⚡ Synthesizing Chirp3-HD Fenrir (Energetic YouTube Narrator) Clips...\n');
    ...
    console.log('\n🎉 Chirp3-HD Fenrir Synthesis Complete!');
}

await generateFenrir();

// Refresh the readable script here too, not only at the end of a render.
// Tying it to the build meant that any run stopped early — or any failed
// render — left the document showing narration that no longer existed.
// The script is what gets reviewed; it should never wait on ffmpeg.
