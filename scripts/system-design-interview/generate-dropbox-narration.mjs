/**
 * generate-dropbox-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Dropbox (Block Storage, CDC Chunking & Metadata Sync).
 *
 * Output: public/assets/system-design-narration/sd-dropbox/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-dropbox/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing Dropbox Chirp3-HD Fenrir Narration Clips...\n');
