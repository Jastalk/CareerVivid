/**
 * generate-discord-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Discord (10M Concurrent Voice & Text Channels).
 *
 * Output: public/assets/system-design-narration/sd-discord/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-discord/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing Discord Chirp3-HD Fenrir Narration Clips...\n');
