/**
 * generate-3-aug9-thumbnails.mjs
 *
 * Composites Layer 1 background plates with Layer 2 Playwright DOM typography:
 *   1. YouTube Content ID -> public/system-design-lessons/design-yt-contentid-thumbnail.jpg
 *   2. WhatsApp E2EE -> public/system-design-lessons/design-whatsapp-e2ee-thumbnail.jpg
 *   3. Vector DB RAG -> public/system-design-lessons/design-vector-rag-thumbnail.jpg
 */
...
const THUMBNAILS = [
    {
        id: 'sd-yt-contentid',
        platePath: path.resolve('/Users/jiawenzhu/.gemini/antigravity/brain/d6232b6d-b67c-464e-b43d-b106a4a0d940/sd_yt_contentid_plate_1786284999482.jpg'),
        outPath: path.resolve('public/system-design-lessons/design-yt-contentid-thumbnail.jpg'),
        badge: 'YOUTUBE CONTENT ID ENGINE',
        titleLine1: 'MINHASH LSH FINGERPRINTING',
        titleLine2: 'SUB-100MS RECALL AT SCALE',
        metric: '500 HRS/MIN UPLOAD'
    },
    {
        id: 'sd-whatsapp-e2ee',
        platePath: path.resolve('/Users/jiawenzhu/.gemini/antigravity/brain/d6232b6d-b67c-464e-b43d-b106a4a0d940/sd_whatsapp_e2ee_plate_1786285009611.jpg'),
        outPath: path.resolve('public/system-design-lessons/design-whatsapp-e2ee-thumbnail.jpg'),
        badge: 'WHATSAPP E2EE SIGNAL PROTOCOL',
        titleLine1: 'DOUBLE RATCHET AES-256',
        titleLine2: 'X3DH OFFLINE HANDSHAKE',
        metric: '100B MSG/DAY E2EE'
    },
    {
        id: 'sd-vector-rag',
        platePath: path.resolve('/Users/jiawenzhu/.gemini/antigravity/brain/d6232b6d-b67c-464e-b43d-b106a4a0d940/sd_vector_rag_plate_1786285021404.jpg'),
        outPath: path.resolve('public/system-design-lessons/design-vector-rag-thumbnail.jpg'),
        badge: 'VECTOR DB HYBRID RAG',
        titleLine1: 'HNSW GRAPH + IVF-PQ 8X',
        titleLine2: 'SUB-10MS HYBRID RETRIEVAL',
        metric: '10B VECTORS @ 50K QPS'
    }
];

async function generateThumbnails() {
    console.log('🎨 Compositing 16:9 High-CTR Thumbnails for 3 Aug 9 Topics...\n');
