/**
 * build-3-aug8-films.mjs
 *
 * Compiles 1080p Master Explainer Films in unified 16:9 horizontal format for YouTube & TikTok:
 *   1. TikTok Live Gifting & Real-Time Leaderboards (design-tiktok-gifting.mp4)
 *   2. OpenAI Realtime Voice WebRTC Gateway (design-openai-realtime.mp4)
 *   3. Uber H3 Hexagonal Indexing & Dynamic Surge (design-uber-h3.mp4)
 */
...
const VIDEO_CONFIGS = [
    {
        ...
        title: 'How to Design TikTok Live Gifting & Real-Time Leaderboards (500K QPS)',
    ...
    {
        id: UBER_H3_SCRIPT.id,
        slug: 'design-uber-h3',
        title: 'How to Design Uber H3 Hexagonal Geospatial Indexing & Dynamic Surge',
        beats: UBER_H3_SCRIPT.beats,
        thumbnail: path.resolve('public/system-design-lessons/design-uber-h3-thumbnail.jpg')
    }
];
...
async function main() {
    ...
    console.log('🎉 ALL 3 AUG 8 1080P MASTER FILMS COMPILED SUCCESSFULLY!');
}
