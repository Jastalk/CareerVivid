/**
 * generate-whatsapp-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design WhatsApp (Real-Time Messaging & WebSockets).
 *
 * Output: public/assets/system-design-narration/sd-whatsapp/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-whatsapp/en/chirp-fenrir';
...
async function generateWhatsAppNarration() {
    console.log('⚡ Synthesizing How to Design WhatsApp Chirp3-HD Fenrir Narration Clips...\n');
    const token = await getToken();

    for (const beat of SYSTEM_DESIGN_WHATSAPP_BEATS) {
