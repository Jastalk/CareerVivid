/**
 * generate-instagram-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Instagram.
 *
 * Output: public/assets/system-design-narration/sd-instagram/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-instagram/en/chirp-fenrir';
...
async function generateInstagramNarration() {
    console.log('⚡ Synthesizing How to Design Instagram Chirp3-HD Fenrir Narration Clips...\n');
