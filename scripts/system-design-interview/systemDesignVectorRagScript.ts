...
export const VECTOR_RAG_BEATS: BeatSpec[] = [
    {
        id: 'beat-1-hook',
        renderer: 'VEO',
        title: { en: 'The 10 Billion Vector Problem' },
        narration: {
            en: "Searching 10 billion high-dimensional embeddings in under 10 milliseconds is the core bottleneck of modern enterprise AI. Here is how engineers build sharded vector databases that deliver sub-10ms hybrid retrieval at 50,000 queries per second!"
        },
    ...
    },
    {
        ...
        narration: {
            en: "Our architecture must index 10 billion 1536-dimensional vectors, support dense vector similarity alongside sparse BM25 keyword matching, guarantee p99 latency under 8 milliseconds, and achieve 98% recall accuracy while keeping memory overhead under 16 gigabytes per shard."
        },
    ...
    },
    {
        ...
        narration: {
            en: "In a naive setup, we store 10 billion float32 vectors in raw uncompressed arrays. Performing an exact brute-force cosine distance comparison requires scanning 60 gigabytes of data per query, melting single-node CPU memory bandwidth instantly."
        },
    ...
    },
    {
        ...
        narration: {
            en: "Under 50,000 QPS, brute-force search crashes with out-of-memory errors. Latency explodes past 4,500 milliseconds, memory bus contention locks all CPU cores, and pure vector cosine search fails to match exact keyword product IDs or serial numbers."
        },
        ...
        diagramSpec: {
            ...
            edges: [
                ...
                { from: 'bus', to: 'crash', label: 'Memory Bus Lockupup', appearsAtSec: 3.2 }
            ]
        }
    },
    {
        ...
        narration: {
            en: "To solve this, we shard the 10 billion vectors across 256 index nodes. Each node runs Product Quantization to compress 1536-dimensional vectors by 8 times, combined with an HNSW graph index for sub-millisecond graph traversal and a BM25 inverted index for exact lexical matching."
        },
    ...
    },
    {
        ...
        narration: {
            en: "When candidate results return from all 256 shards, a GPU-accelerated Scatter-Gather coordinator executes Reciprocal Rank Fusion to combine dense cosine scores and sparse BM25 scores. A lightweight cross-encoder reranker then scores the top 100 candidates in 2.5 milliseconds."
        },
    ...
    },
    {
        ...
        narration: {
            en: "By adopting IVF-PQ with HNSW, we slash overall cluster RAM from 600 gigabytes down to just 75 gigabytes, reducing infrastructure costs by 87% while maintaining a 98.4% recall rate and sub-8ms P99 latency."
        },
    ...
    },
    {
        ...
        narration: {
            en: "That is how you design a 10-billion vector hybrid RAG system with sub-10ms latency! If you enjoyed this system design breakdown, make sure to like and subscribe for more! Practice interactive scenarios and 300+ real tech company interview questions today on CareerVivid!"
        },
