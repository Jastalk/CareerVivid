/**
 * generate-netflix-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Netflix (Adaptive Bitrate ABR & Edge CDN).
 *
 * Output: public/assets/system-design-narration/sd-netflix/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-netflix/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing Netflix Chirp3-HD Fenrir Narration Clips...\n');
