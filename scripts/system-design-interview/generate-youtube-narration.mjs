/**
 * generate-youtube-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design YouTube.
 *
 * Output: public/assets/system-design-narration/sd-youtube/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-youtube/en/chirp-fenrir';
...
async function generateYouTubeNarration() {
    console.log('⚡ Synthesizing How to Design YouTube Chirp3-HD Fenrir Narration Clips...\n');
