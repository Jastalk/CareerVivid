/**
 * generate-ubersurge-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Uber Surge Pricing Engine & Real-Time Heatmaps.
 *
 * Output: public/assets/system-design-narration/sd-ubersurge/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-ubersurge/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing Uber Surge Chirp3-HD Fenrir Narration Clips...\n');
