/**
 * generate-ytlive-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design YouTube Live Streaming at Scale.
 *
 * Output: public/assets/system-design-narration/sd-ytlive/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-ytlive/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing YouTube Live Chirp3-HD Fenrir Narration Clips...\n');
