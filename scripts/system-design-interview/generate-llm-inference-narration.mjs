/**
 * generate-llm-inference-narration.mjs
 *
 ...
 *   (PagedAttention, Continuous Batching & KV-Cache Management).
 *
 * Output: public/assets/system-design-narration/sd-llm-inference/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-llm-inference/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing LLM Inference Serving Chirp3-HD Fenrir Narration Clips...\n');
