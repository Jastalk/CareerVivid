/**
 * generate-tiktok-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design TikTok (Video Recommendation Engine).
 *
 * Output: public/assets/system-design-narration/sd-tiktok/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-tiktok/en/chirp-fenrir';
...
async function generateTikTokNarration() {
    console.log('⚡ Synthesizing How to Design TikTok Chirp3-HD Fenrir Narration Clips...\n');
