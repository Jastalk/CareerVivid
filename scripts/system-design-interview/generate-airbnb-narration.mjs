/**
 * generate-airbnb-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Airbnb.
 *
 * Output: public/assets/system-design-narration/sd-airbnb/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-airbnb/en/chirp-fenrir';
...
async function generateAirbnbNarration() {
    console.log('⚡ Synthesizing How to Design Airbnb Chirp3-HD Fenrir Narration Clips...\n');
