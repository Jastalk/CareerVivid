/**
 * generate-cache-rate-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: Caching & Rate Limiting.
 *
 * Output: public/assets/ccaf-narration/sd-cache-rate/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-cache-rate/en/chirp-fenrir';
...
async function generateCacheRateNarration() {
    console.log('⚡ Synthesizing Caching & Rate Limiting Chirp3-HD Fenrir Narration Clips...\n');
