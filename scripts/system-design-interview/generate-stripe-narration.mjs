/**
 * generate-stripe-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Stripe (Idempotency, 2PC vs Saga & Outbox CDC).
 *
 * Output: public/assets/system-design-narration/sd-stripe/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-stripe/en/chirp-fenrir';
...
async function generateNarration() {
    console.log('⚡ Synthesizing Stripe Chirp3-HD Fenrir Narration Clips...\n');
