/**
 * generate-claudecode-narration.mjs
 *
 * Synthesizes Chirp3-HD-Fenrir English voiceover narration clips
 * for System Design: How to Design Claude Code / Agentic AI System.
 *
 * Output: public/assets/system-design-narration/sd-claudecode/en/chirp-fenrir/<beatId>.wav
 */
...
const OUT_DIR = 'public/assets/system-design-narration/sd-claudecode/en/chirp-fenrir';
...
async function generateClaudeCodeNarration() {
    console.log('⚡ Synthesizing How to Design Claude Code Chirp3-HD Fenrir Narration Clips...\n');
